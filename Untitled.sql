...
ALTER TABLE [ajouterType] ADD FOREIGN KEY ([id_type]) REFERENCES [type] ([id_type])
GO

ALTER TABLE [ajouterType] ADD FOREIGN KEY ([id_livre]) REFERENCES [livre] ([id_livre])
GO
